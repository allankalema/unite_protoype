...
urlpatterns = [
    ...
    path("dashboard/courses/<int:course_id>/", views.course_detail_admin_view, name="course-detail"),
    ...
    path("dashboard/modules/<int:module_id>/", views.module_detail_admin_view, name="module-detail"),
    ...
    path("dashboard/lessons/<int:lesson_id>/", views.lesson_detail_admin_view, name="lesson-detail"),
    ...
    path("dashboard/resources/", views.manage_resources_view, name="manage-resources"),
    path("dashboard/resources/<int:resource_id>/", views.resource_detail_admin_view, name="resource-detail"),
    path("dashboard/resources/create/", views.create_lesson_resource_view, name="create-resource"),
    path("dashboard/resources/<int:resource_id>/edit/", views.edit_lesson_resource_view, name="edit-resource"),
    path("dashboard/resources/<int:resource_id>/delete/", views.delete_lesson_resource_view, name="delete-resource"),
    ...
    path("dashboard/enrollments/<int:enrollment_id>/", views.enrollment_detail_admin_view, name="enrollment-detail"),
